...
public class Game
{
    ...
    public void ShowMap()
    {
        if (hasMap) // Check if the player has the map
        {
            ...
            Console.WriteLine("                                             +------------------+");
            Console.WriteLine("                                             | Community Health |");
            ...
            Console.WriteLine("                                                      |");
            Console.WriteLine("                     +------------------+    +------------------+    +------------------+");
            Console.WriteLine("                     |  River Upstream  |----| Village Town Hall|----|      Dry Well    |");
            Console.WriteLine("                     +------------------+    +------------------+    +------------------+");
            Console.WriteLine("                                                      |");
            Console.WriteLine("                                                      |");
            Console.WriteLine("                                                      |");
            Console.WriteLine("                                                      |");
            Console.WriteLine("                     + ----------------- +    +------------------+    +-------------------------------+  ");
            Console.WriteLine("                     |  Engineer Tomas's |----|  Leaking Pipes   |----|  Rainwater Harvesting System  |  ");
            Console.WriteLine("                     |     Workshop      |    +------------------+    +-------------------------------+  ");
            Console.WriteLine("                     +------------------ +            |");
            Console.WriteLine("                                                      |");
            Console.WriteLine("                                                      |");
            Console.WriteLine("                                       +-------------------------------+");
            Console.WriteLine("                                       |   Contaminated Water Storage  |");
